...
class CircleSocial extends StatelessWidget {
  ...
  const CircleSocial({Key? key, required this.socialImgUrl, required this.socialUrl, required this.tooltip})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return IconButton(
        ...
        icon: Container(
            ...
            child: Container(
                decoration:
                    BoxDecoration(shape: BoxShape.circle, image: DecorationImage(image: NetworkImage(socialImgUrl)))),
